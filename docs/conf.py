...
htmlhelp_basename = 'VSICommondoc'
...
latex_documents = [
    (master_doc, 'VSICommon.tex', 'VSI Common Documentation',
     'Vision Systems, Inc', 'manual'),
]
...
man_pages = [
    (master_doc, 'vsicommon', 'VSI Common Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VSICommon', 'VSI Common Documentation',
     author, 'VSICommon', 'One line description of project.',
     'Miscellaneous'),
]
